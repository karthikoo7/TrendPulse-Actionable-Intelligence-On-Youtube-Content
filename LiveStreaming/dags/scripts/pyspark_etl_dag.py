...
# Define DAG
with DAG(
    dag_id="youtube_trend_analysis_etl_streaming",
    default_args=default_args,
    description="End-to-End YouTube Trend Analysis using STREAMING PySpark, Kafka, HDFS, and Google Sheets",
    ...
    # Task 3: PySpark STREAMING ETL (Kafka -> Feature Engineering -> HDFS Output)
    pyspark_etl_task = SparkSubmitOperator(
        task_id="pyspark_trend_analysis_streaming",
